...
public class IPynbAIQualityProfile implements BuiltInQualityProfilesDefinition {
  ...
  public IPynbAIQualityProfile(RepositoryInfoProvider[] editionMetadataProviders) {
  ...
  private static void registerRulesForEdition(RepositoryInfoProvider repositoryInfoProvider, NewBuiltInQualityProfile profile) {
    RepositoryInfo repositoryInfo = repositoryInfoProvider.getIPynbAIProfileInfo();
